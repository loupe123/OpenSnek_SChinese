...
struct LocalProfileLibraryPanel: View {
    ...
    private var localProfileSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text(LocalizedStringKey(selectedSlotIsAssigned ? "Replace Selected Profile With" : "Load Profile")).font(.system(size: 11, weight: .black, design: .rounded)).foregroundStyle(.white.opacity(0.74))
